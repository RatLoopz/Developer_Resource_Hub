...
export default function AdminPage() {
  ...
  const handleEditReelSave = async () => {
    ...
    if (!error) {
      setReels((prev) =>
        prev.map((r) => (r.id === editingReel.id ? editingReel : r)),
      );
      setEditingReel(null);
    }
    setUpdating(null);
      ...
      <section className="mx-auto max-w-7xl px-6 py-10">
            ...
            {[
              {
                ...
                target: "links" as TabId,
                sub: "All submitted resources",
              },
              {
                label: "Active Links",
                value: stats.active,
              ...
              },
              {
                ...
                value: stats.reels,
                color: "text-neutral-900",
                target: "reels" as TabId,
                sub: "Instagram reel links",
              },
              {
                label: "Total Members",
                value: stats.members,
                color: "text-neutral-900",
                target: "users" as TabId,
              ...
              links.map((link) => (
                ...
                >
                  ...
                  <div className="flex gap-1 shrink-0">
                    ...
                    <button
                      onClick={() =>
                        handleStatusChange(
                          link.id,
                          link.status === "broken" ? "inactive" : "broken",
                        )
                      }
                      disabled={updating === link.id}
                      className={`text-[10px] font-medium px-2.5 py-1 rounded-md transition-colors ${
                  ...
                  <div className="flex gap-1 shrink-0">
                    ...
                    <button
                      onClick={() =>
                        setDeleteTarget({ id: link.id, table: "links" })
                      }
        ...
        {tab === "reels" && (
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
            {reels.length === 0 ? (
              <p className="col-span-full text-sm text-neutral-400 py-12 text-center">
                No reels saved.
              </p>
            ) : (
              reels.map((reel) => (
                ...
                >
                  ...
                  <div className="p-2.5">
                    ...
                    <div className="mt-2 flex items-center gap-1.5">
                      ...
                      <button
                        onClick={() =>
                          setDeleteTarget({ id: reel.id, table: "reels" })
                        }
          ...
          <div className="space-y-2">
            {users.length === 0 ? (
              ...
              users.map((u) => (
                <div
                  key={u.id}
                  className="flex items-center gap-4 border border-neutral-200 rounded-xl px-4 py-3"
                >
                  {/* Avatar initials */}
                  ...
                  <span
                    className={`text-[10px] font-medium px-2.5 py-1 rounded-md shrink-0 ${
                      u.role === "admin"
                  ...
                  <button
                    onClick={() =>
                      setDeleteTarget({ id: u.id, table: "profiles" })
                    }
                    disabled={u.role === "admin"}
                    title={
                      u.role === "admin" ? "Cannot delete admin" : "Delete user"
                    }
        ...
        <DialogContent className="max-w-md">
          ...
          <DialogFooter className="mt-4">
            ...
            <Button
              ...
              disabled={updating === editingLink?.id}
      ...
      >
        <DialogContent className="max-w-md">
            ...
            <div className="space-y-4 mt-2">
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    setEditingReel({ ...editingReel, notes: e.target.value })
                  }
                  rows={2}
                  className="resize-none text-sm"
          ...
          <DialogFooter className="mt-4">
            ...
            <Button
              size="sm"
              onClick={handleEditReelSave}
              disabled={updating === editingReel?.id}
              className="bg-neutral-950 text-white hover:bg-neutral-800"
            >
